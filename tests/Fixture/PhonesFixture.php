...
class PhonesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'manufacturer' => ['type' => 'string', 'length' => 50, 'null' => true, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2018-05-12 05:02:30',
                'modified' => '2018-05-12 05:02:30'
            ],
        ];
        parent::init();
    }
